...
@export
(defgeneric attach-image (object src)
  (:method (object (src string))
  ...
  (:method (object (src simple-vector))
    (error "There is not method of attach-image with raw image.")))

(defmethod attach-image :around (object src)
  (declare (ignore src))
